  ...
  return (
    <main id="main">
      ...
      <section className="about-intro page-section">
        ...
        <div className="prose">
          <p>
            We integrate engineering analysis, design review, troubleshooting, technical audits and
            execution support to help clients make confident decisions.
          </p>
          <p>
      ...
      <section className="vision-grid page-section">
        <article>
          <span>VISION</span>
          <h2>To be a trusted engineering and projects partner.</h2>
          <p>Known for technical depth, practical judgement and responsible engineering.</p>
        </article>
        <article>
          <span>MISSION</span>
          <h2>To turn complexity into implementable solutions.</h2>
          <p>Protecting people, assets, uptime and investment through clear engineering.</p>
        </article>
      </section>
      <section className="values-section page-section">
        <SectionLead index="B" label="Values" title="The standards behind every decision." />

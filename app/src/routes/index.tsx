...
import { ArrowUpRight, ContactBay, Eyebrow, SectionLead, SnapSlider } from "../components/Site";
    ...
    <main id="main">
      <section className="home-hero">
        <img
          ...
          src="/assets/yukti-engineering-hero.webp"
          alt="Integrated electrical, structural and mechanical engineering infrastructure at blue hour"
          fetchPriority="high"
        />
        ...
        <div className="hero-content">
          ...
          <p>
            Practical, technically sound engineering support across electrical, civil, structural
      ...
      <section className="manifesto page-section">
        ...
        <p className="manifesto-statement">
          We turn complex engineering problems into <strong>implementable solutions</strong> that
          protect people, assets, uptime and investment.
        </p>
        <aside>
          <span>01</span>
          <p>Understand the real problem before defining the intervention.</p>
          <span>02</span>
          <p>Engineer in proportion to risk, need and operating context.</p>
          <span>03</span>
          <p>Carry technical intent through documentation and execution.</p>
        </aside>
      </section>
      ...
      <section className="services-section page-section">
        <SectionLead
          ...
          title="Multidisciplinary thinking. One practical direction."
          text="Deep discipline capability, coordinated around the outcome your project actually needs."
        />
        <div className="discipline-list">
          {services.slice(0, 3).map((service) => (
            <a key={service.slug} href={`/services/${service.slug}`} className="discipline-row">
              <span>{service.index}</span>
              <h3>{service.title}</h3>
              <p>{service.short}</p>
              <b>
      ...
      <section className="method-section">
        <div className="page-section">
          <SectionLead
            index="02"
            label="Method"
            title="A direct line from uncertainty to value."
            light
          />
          <div className="method-line">
            {[
              ["01", "Understand", "Evidence, context and root cause."],
              ["02", "Engineer", "Analysis, options and proportionate design."],
              ["03", "Deliver", "Clear documentation and execution support."],
            ].map(([i, t, p]) => (
              <article key={t}>
                <span>{i}</span>
                <h3>{t}</h3>
          ...
          <p className="method-mantra">
            UNDERSTAND THE PROBLEM. <strong>ENGINEER THE SOLUTION.</strong> DELIVER THE VALUE.
          </p>
        </div>
      </section>
      ...
      <section className="image-story page-section">
        <SectionLead
          index="03"
          label="In practice"
          title="Systems do not work in silos. Neither do we."
      ...
      <section className="sectors-section page-section">
        <SectionLead
          index="04"
          label="Sectors"
          title="Engineering judgement for demanding operating contexts."
        />
        <div className="sector-matrix">
          {sectors.map(([i, t, p]) => (
            <a key={t} href="/sectors">
              <span>{i}</span>
              <h3>{t}</h3>
              <p>{p}</p>
            </a>
      ...
      <section className="sector-feature">
        <img
          ...
          alt="Integrated substation, renewable energy, process plant and bridge infrastructure"
          loading="lazy"
        />
        <div>
          <Eyebrow light>Connected infrastructure</Eyebrow>
          <h2>One engineering view across the whole asset.</h2>
          <a className="text-link text-link-light" href="/sectors">
            Explore sectors{" "}
            <span>
              <ArrowUpRight />
            </span>
